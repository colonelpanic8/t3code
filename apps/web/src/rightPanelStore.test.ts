...
describe("rightPanelStore", () => {
  ...
  it.each([
    ...
    {
      choice: "thread panel close",
      choose: () => useRightPanelStore.getState().setThreadPanelOpen(refA, "inline", false),
    },
    {
      choice: "thread panel toggle",
      choose: () => useRightPanelStore.getState().toggleThreadPanel(refA, "inline"),
    },
    {
