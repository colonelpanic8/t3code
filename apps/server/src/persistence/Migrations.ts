...
// Migrations 050-052 come from main and are renumbered above the
// orchestration-v2 range (041-049) so no recorded migration ID is reused.
import Migration0050 from "./Migrations/050_AuthSessionClientConnection.ts";
...
import Migration0053 from "./Migrations/053_ProjectionThreadSchemaCompatibility.ts";
...
export const migrationEntries = [
  ...
  [53, "ProjectionThreadSchemaCompatibility", Migration0053],
] as const;
