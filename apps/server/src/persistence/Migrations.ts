...
import Migration0039 from "./Migrations/039_OrchestrationV2.ts";
import Migration0040 from "./Migrations/040_OrchestrationV2Subagents.ts";
import Migration0041 from "./Migrations/041_OrchestrationV2Foundation.ts";
import Migration0042 from "./Migrations/042_OrchestrationV2ProviderSessionBindings.ts";
import Migration0043 from "./Migrations/043_OrchestrationV2ThreadLaunchWorkflows.ts";
import Migration0044 from "./Migrations/044_ApplicationEventSource.ts";
import Migration0045 from "./Migrations/045_OrchestrationV2EffectCancellation.ts";
import Migration0046 from "./Migrations/046_ScheduledTasks.ts";
import Migration0047 from "./Migrations/047_LegacyV1ImportState.ts";
import Migration0048 from "./Migrations/048_ProjectionProjectsDefaultThreadEnvMode.ts";
import Migration0049 from "./Migrations/049_ProjectionProjectFaviconPath.ts";
...
export const migrationEntries = [
  ...
  [39, "OrchestrationV2", Migration0039],
  [40, "OrchestrationV2Subagents", Migration0040],
  [41, "OrchestrationV2Foundation", Migration0041],
  [42, "OrchestrationV2ProviderSessionBindings", Migration0042],
  [43, "OrchestrationV2ThreadLaunchWorkflows", Migration0043],
  [44, "ApplicationEventSource", Migration0044],
  [45, "OrchestrationV2EffectCancellation", Migration0045],
  [46, "ScheduledTasks", Migration0046],
  [47, "LegacyV1ImportState", Migration0047],
