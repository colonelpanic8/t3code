...
- `.github/workflows/android-stack-build.yml` builds an installable Android APK on a GitHub-hosted runner without EAS, for forks that cannot use the `mobile-eas-*` workflows. See [Android stack build](./android-stack-build.md).
