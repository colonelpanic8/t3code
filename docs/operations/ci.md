...
- `.github/workflows/android-assembly-build.yml` builds an installable Android APK on a GitHub-hosted runner without EAS, for forks that cannot use the `mobile-eas-*` workflows. See [Android assembly build](./android-assembly-build.md).
